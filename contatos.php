...
<body>
    ...
    <form action="PHP/controler.php" method="POST" class="form_main">
        ...
        <div class="inputContainer">
            ...
            <input type="email" class="inputField" id="Email" placeholder="EMAIL" name="email">
        </div>
        ...
        <div class="inputContainer">
            ...
            <input type="password" class="inputField" id="Senha" placeholder="SENHA" name="senha">
        </div>
